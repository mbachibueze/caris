      ...
      >
        <div className="relative h-full flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* Close Button */}
            <div
              className=" bg-gray-100/20 p-1 rounded-lg w-fit cursor-pointer"
          ...
          <Link href="/signIn">
            <button className="bg-[#1b5af5] text-white hover:bg-[#c5832b]  shadow transition-all duration-200 lg:px-7 px-4  py-4 md:rounded-xl rounded-lg lg:text-lg md:text-base sm:text-base text-[5vw] cursor-pointer w-full absolute bottom-10">
              Sign In
            </button>
          </Link>
        </div>
