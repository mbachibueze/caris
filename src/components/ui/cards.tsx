...
import { BsCalendar2Check,BsFillHeartPulseFill, BsHospital, BsPeople } from "react-icons/bs";
        ...
        <div className="lg:grid lg:grid-cols-2 gap-2 flex flex-col  justify-between items-center  w-[90%]  m-auto m text-[#0d1321]  ">
          ...
          <div className=" flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <h1 className="capitalize font-medium lg:text-7xl md:text-7xl sm:text-6xl text-4xl leading-tight ">{head} <span className="text-[#327cff]">{head2}</span> </h1>

                <p className="lg:text-lg w-[100%] md:text-xl sm:text-lg  leading-relaxed lg:w-[90%] font-medium">{description}</p>
              </div>
            
            <Link href='../signIn'>
              <button className="bg-[#1b5af5] text-white p-2 w-fit px-8 rounded-full cursor-pointer flex items-center gap-2 font-medium"><RiCalendarScheduleLine size={25} /> {btn}</button>
            </Link>
...
export const Special = () => {
  return (
    <div className=" md:w-[90%] w-[95%] mx-auto grid place-items-center ">
        ...
        <div>
          <div className=" flex flex-col gap-2 py-5 p-3 text-center md:text-left items-center sm:items-start">
            <div className="flex flex-col gap-2">
              ...
              <h1 className="capitalize font-bold md:text-5xl text-3xl">What makes us special </h1>
              <p className="text-gray-600 font-medium md:text-base text-sm">At Caris+, we are passionate revolutionizing healthcare by bridging the gap between patients and top healthcare professionals</p>
            </div>
            ...
            <div className="mt-8 mx-">
              <ul className="font-medium flex flex-col gap-3 [&_span]:bg-blue-700 [&_span]:w-6 [&_span]:h-6 [&_span]:rounded-full [&_li]:flex [&_li]:items-center [&_li]:gap-2 ">
                <li><span ></span> Patient-Centered Care</li>
                <li><span ></span> Experienced Medical Professionals</li>
                <li><span ></span> 24/7 Medical Emergency</li>
                <li><span ></span> Equipped Facilities</li>
              </ul>
            </div>
          </div>
        </div>
  ...
  return (
    <section className="w-[90%]  mx-auto  my-15 py-5 flex flex-col gap-10">
      ...
      <div className="text-center">
          <h3 className="uppercase font-semibold text-lg text-[#1b5af5] ">services</h3>
          <h1 className="capitalize font-bold text-5xl">what we offer</h1>
          <p className="text-gray-600">At Caris+, we offer a range of services designed to make healthcare accessible, convenient, and patient-centered. Here's how we can help you:</p>
      </div>
      ...
      <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-5 [&_main]:cursor-pointer  [&_main]:border-white [&_main]:p-5 [&_main]:py-10 [&_main]:w-fit [&_main]:flex [&_main]:flex-col [&_main]:items-center [&_main]:text-center [&_main]:gap-2  [&_div]:p-5 [&_div]:rounded-full [&h1]:font-semibold [&_h1]:text-lg ">
        ...
        <main className="cardShadow">
          ...
          <p>Easily book and manage vaccination appointments for your child with certified healthcare professionals.</p>
        </main>
        ...
        <main className="cardShadow">
          ...
          <p>Connect instantly with paediatric specialists for expert advice on your child’s health and development.</p>
        </main>
        ...
        <main className="cardShadow">
          ...
          <p>Track your child’s vaccination history and receive reminders for upcoming doses.</p>
        </main>
        ...
        {/* <main className="cardShadow">
         ...
         <main className="cardShadow">
          ...
          <p>Find nearby hospitals and vaccination centres with available paediatricians for in-person appointments.</p>
        </main>
...
export const DoctorCard: React.FC<doctors> = ({name, specialty, imageSrc}) => {
  return (
    <section className="text-center flex flex-col gap-2">
        ...
        <div className="text-center flex flex-col items-center [&_p]:text-gray-600  [&_p]:text-sm">
          ...
          <p className="flex items-center gap-2 "><MdOutlineStar /> 4.5 (900 Reviews)</p>
        </div>
  ...
  return (
    <section className="lg:w-[90vw] w-[95%] mx-auto  my-15 ">
      <main className="flex flex-col gap-10">
        <div className="text-center ">
          <h3 className="uppercase font-semibold text-lg text-[#1b5af5] ">doctors</h3>
          <h1 className="capitalize font-bold text-5xl">Meet our professional doctors</h1>
        </div>
